...
void test_object_cleanup(CuTest *tc)
{
    ...
    aos_status_t *s;
    oss_request_options_t *options;
    char *object_name1 = "oss_test_put_object";
    char *object_name2 = "oss_test_put_object_from_file";
...
void test_put_object_from_file(CuTest *tc)
{
    ...
    char *filename = "./oss_c_sdk_sample";
    aos_status_t *s;
    oss_request_options_t *options;
    int is_oss_domain = 1;
    aos_table_t *headers;
...
void test_copy_object(CuTest *tc)
{
    ...
    char *source_object_name = "oss_test_put_object";
...
void test_object_by_url(CuTest *tc)
{
    ...
    //test expired url for put_object_from_buffer
    url_str = gen_test_signed_url(options, TEST_BUCKET_NAME, object_name, expired_time, req);
    aos_str_set(&url, url_str);
    s = oss_put_object_from_buffer_by_url(options, &url, &buffer, headers, &resp_headers);
    CuAssertIntEquals(tc, 403, s->code);
    CuAssertStrEquals(tc, "AccessDenied", s->error_code);
    CuAssertTrue(tc, s->req_id != NULL);

    //test expired url for put_object_from_file
    s = oss_put_object_from_file_by_url(options, &url, &file, headers, &resp_headers);
    CuAssertIntEquals(tc, 403, s->code);
    CuAssertStrEquals(tc, "AccessDenied", s->error_code);
    CuAssertTrue(tc, s->req_id != NULL);
    ...
    //test expired url for get_object_to_buffer
    url_str = gen_test_signed_url(options, TEST_BUCKET_NAME, object_name, expired_time, req);
    aos_str_set(&url, url_str);
    s = oss_get_object_to_buffer_by_url(options, &url, headers, &buffer, &resp_headers);
    CuAssertIntEquals(tc, 403, s->code);
    ...
    //test expired url for get_object_to_file
    s = oss_get_object_to_file_by_url(options, &url, headers, &file, &resp_headers);
    CuAssertIntEquals(tc, 403, s->code);
    CuAssertStrEquals(tc, "AccessDenied", s->error_code);
    CuAssertTrue(tc, s->req_id != NULL);
    ...
    //test expired url for head_object
    url_str = gen_test_signed_url(options, TEST_BUCKET_NAME, object_name, expired_time, req);
    aos_str_set(&url, url_str);
    s = oss_head_object_by_url(options, &url, headers, &resp_headers);
    CuAssertIntEquals(tc, 403, s->code);
